  ...
  return (
    <div id="inicio" className='relative w-full h-screen'>
        ...
        <div className='absolute inset-0 z-10 flex flex-col items-center px-12 justify-start text-white pt-40'>
            ...
            <button className='px-16 py-3 text-sm font-medium text-black transition-all duration-300 border-none rounded-xl mt-4 bg-white'><a href="#tendencia">Ver películas</a></button>
        </div>
    </div>
  )
}
